...
class TrajectoryDataset(Dataset):
    ...
    The gyroscope channels form the ODE state. Unlike the controlled variant,
    the accelerometer is ignored: the field is autonomous (``dx/dt = f(x)``),
    so there is no control and no continuous-control spline. Windows never cross
    instance boundaries.
    """
